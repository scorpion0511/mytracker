...
<body>
	...
	<h5  class="header"><span id="note">${note}</span></h5>
	<div class="container">
	<div id="screen"> 
            <button id="closeButton" type="button" class="btn btn-warning btn-xs ">Close</button>
</div>
        <div id="displayDiagram"><img id="diagramImage" src="dummy">
        </div>
		<div class="row">
				...
				<form id="myForm">
					<table id="tableId" class="table table-bordered">
						<thead>
							<tr>
								<th>Categories</th>
								<th>Rows/Links to create</th>
								<th>Chunks [Commit per]</th>
								<th>Selection<span > [All <input id="selectAllCategories" type="checkbox">]</span></th>
							</tr>
						</thead>
						<tbody>
							<c:forEach items="${list}" var="item">
								<tr>
									...
									<td><input class="numberWidth" type="text"
										value="${item.chunk}"></td>
									<td><input class ="categorySelect" type="checkbox">
									
									<button type="button" name ="${item.name}" class="btn btn-xs showDiagram">Diagram</button></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
