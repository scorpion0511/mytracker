...
$(document).ready(function() {
	...
	$('#selectAllCategories').on("click", function(e) {
...
function toggleAllSelections(e)
{
	if ($('#selectAllCategories').prop('checked') == true)
	{
		$('.categorySelect').prop('checked', true);
	}
	else
	{
...
function showDiagram(e)
{
	$('#displayDiagram').show();
	$('#screen').show();
	$('#diagramImage').attr('src','/images/diagrams/' + e.target.name + '.png');
}
